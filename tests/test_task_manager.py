...
class TestTaskManager:
    ...
    def test_get_tasks_by_priority(self):
        ...
        task3 = self.manager.create_task(title="Urgent Task", priority=TaskPriority.URGENT)
    ...
    def test_search_tasks(self):
        ...
        task1 = self.manager.create_task(title="Python Project", description="Backend development", tags=["python", "backend"])
        task2 = self.manager.create_task(title="Web Design", description="Frontend project", tags=["design", "frontend"])
        task3 = self.manager.create_task(title="Python Tutorial", description="Learning Python", tags=["python", "learning"])
    ...
    def test_get_overdue_tasks(self):
        ...
        task4 = self.manager.create_task(title="Completed Overdue Task", due_date=past_date)
        task4.mark_done()
    ...
    def test_get_statistics(self):
        ...
        # Create overdue task
        past_date = datetime.now() - timedelta(days=1)
        overdue_task = self.manager.create_task(title="Overdue Task", due_date=past_date)
    ...
    def test_export_tasks_markdown(self):
        ...
        self.manager.create_task(title="Markdown Test Task", description="Test description")
